...
export default function App() {
  ...
  const PRICING = {
    ...
    platforms: { facebook: 1500, instagram: 1500, youtube: 2000, google: 1000 }
  };
  ...
  // Reusable Component for Selection Buttons (Now using Minimal Glass Style)
  ...
  return (
    <div className="min-h-screen relative flex flex-col font-sans text-[#1b1c1c] overflow-hidden">
      ...
      <div className="flex-grow flex flex-col items-center justify-center px-4 py-8 relative z-10 w-full max-w-2xl mx-auto">
        ...
        {/* Title Header: Minimalist 2-line styling */}
        ...
        <div className="w-full glass-container rounded-[2rem] sm:rounded-[2.5rem] p-5 sm:p-8 flex flex-col relative overflow-hidden min-h-[420px] sm:min-h-[500px]">
            ...
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <p className="text-xs text-[#a23957] font-mono mt-1.5 mb-6 bg-white/50 inline-block px-2 py-1 rounded-md">₹300 per reel</p>
              ...
              {currentStep === 2 && (
                ...
                >
                  ...
                  <p className="text-xs text-[#a23957] font-mono mt-1.5 mb-6 bg-white/50 inline-block px-2 py-1 rounded-md">₹80 per creative</p>
                  <div className="space-y-2.5">
                    {[4, 8, 12, 16].map(num => (
                      <SelectOption 
              ...
              {currentStep === 3 && (
                ...
                >
                  ...
                  <p className="text-xs text-[#a23957] font-mono mt-1.5 mb-6 bg-white/50 inline-block px-2 py-1 rounded-md">₹1000 each</p>
                  <div className="space-y-2.5">
                    {[1, 2, 3].map(num => (
                      <SelectOption 
              ...
              {currentStep === 4 && (
                ...
                >
                  ...
                  <p className="text-xs text-[#a23957] font-mono mt-1.5 mb-6 bg-white/50 inline-block px-2 py-1 rounded-md">₹3000 per day</p>
                  <div className="space-y-2.5">
                    {[1, 2, 3].map(num => (
                      <SelectOption 
                  ...
                  <div className="glass-input p-5 sm:p-6 rounded-3xl mb-6">
                    ...
                    <div className="space-y-2 mt-4 text-[11px] sm:text-xs text-gray-700 font-medium">
                      ...
                      <div className="pt-2 border-t border-gray-300/50 mt-2">
                        {data.platforms.facebook && <div className="flex justify-between"><span>FB Management</span><span>₹{PRICING.platforms.facebook}</span></div>}
                        {data.platforms.instagram && <div className="flex justify-between"><span>IG Management</span><span>₹{PRICING.platforms.instagram}</span></div>}
                        {data.platforms.youtube && <div className="flex justify-between"><span>YT Management</span><span>₹{PRICING.platforms.youtube}</span></div>}
                        {data.platforms.google && <div className="flex justify-between"><span>Google Profile</span><span>₹{PRICING.platforms.google}</span></div>}
                      </div>
                    </div>
                  </div>
          ...
          {/* Navigation Controls inside the Glass Container (bottom aligned) */}
          {currentStep < 8 && (
